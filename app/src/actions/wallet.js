...
const CREATE_NEW_WALLET='WALLET/CREATE_NEW_WALLET'
const CREATE_NEW_WALLET_START='WALLET/CREATE_NEW_WALLET_START'
const CREATE_NEW_WALLET_SUCCESS='WALLET/CREATE_NEW_WALLET_SUCCESS'
const CREATE_NEW_WALLET_ERROR='WALLET/CREATE_NEW_WALLET_ERROR'
...
export const constants = {
    ...
    CREATE_WALLET_ERROR,
    CREATE_NEW_WALLET,
    CREATE_NEW_WALLET_START,
    CREATE_NEW_WALLET_SUCCESS,
    CREATE_NEW_WALLET_ERROR,
    RESET_STATE,
    LOGIN,
    LOGIN_SUCCESS,
    LOGIN_ERROR,
...
export function createNewWallet(passphrase, wif,name) {
    return {
