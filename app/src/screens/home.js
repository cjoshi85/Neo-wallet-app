        ...
        return (
            <View style={styles.main}>
                ...
                <View style={styles.tiles}>
                    <Tile title="Login With Facebook" onPress={() => this._goToScreen('Login', { useExistingKey: false })} />
                    ...
                    <Tile title="Manage neon settings" dark onPress={() => this._goToScreen('Settings')} />
